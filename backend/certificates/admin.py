...
class CertificateAdmin(admin.ModelAdmin):
    ...
    def publish_certificates(self, request, queryset):
        ...
        self.message_user(
            request, "✅ Certificates have been generated and issued to verified students."
        )
    ...
    def _generate_certificates(self, certificate_obj):
        ...
        enrolled_students = Enrollment.objects.filter(
            course=certificate_obj.course, status="verified"
        )
        ...
        for enrollment in enrolled_students:
            ...
            filename = (
                f"{enrollment.first_name}_{certificate_obj.course.title}_{uuid.uuid4().hex[:6]}.pdf"
            )
    ...
    publish_certificates.short_description = (
        "Publish and issue selected certificates to verified students"
    )
