...
COURSE_SEEDS = [
    {
        ...
        'requirements': ['Laptop or desktop', 'Reliable internet connection', 'Basic HTML, CSS, and JavaScript familiarity'],
        'target_audience': ['Students who want to become full-stack developers', 'Beginners ready for structured live guidance', 'Freelancers building client-ready web apps'],
        'faqs': [
            ('Is this course beginner friendly?', 'Yes. We start with strong fundamentals and gradually move into advanced full-stack workflows.'),
            ('Will I build projects?', 'Yes. You will build multiple guided projects and one strong portfolio-ready capstone.'),
            ('Do I get a certificate?', 'Yes. You receive a certificate after completing the course requirements.'),
        ],
        'comparison_left': [
        ...
        'modules': [
            (
                ...
                ['Component architecture', 'Routing and layout systems', 'State management', 'Responsive UI building'],
            ),
            (
                'Backend and APIs',
                'Create scalable backend flows for real projects.',
                ['Express app structure', 'REST API design', 'JWT authentication', 'Protected routes and validation'],
            ),
            (
                'Database and Deployment',
                'Persist data and take your app live.',
                ['MongoDB schema design', 'CRUD operations', 'Deployment workflow', 'Environment and production basics'],
            ),
        ],
    },
    {
        ...
        'requirements': ['Laptop or desktop', 'Willingness to practice regularly', 'No prior design experience required'],
        'target_audience': ['Students entering UI/UX for the first time', 'Developers improving product thinking', 'Creative learners building a design portfolio'],
        'faqs': [
            ('Do I need prior design knowledge?', 'No. This course is structured for beginners and gradually moves into professional workflows.'),
            ('Which tool will we use?', 'We use Figma for wireframes, components, and prototypes.'),
            ('Will I build portfolio projects?', 'Yes. You will complete practical projects that can be shaped into portfolio case studies.'),
        ],
        'comparison_left': [
        ...
        'modules': [
            (
                ...
                ['User research basics', 'Persona and journey thinking', 'Information architecture', 'Problem framing'],
            ),
            (
                'Wireframes and UI Systems',
                'Turn ideas into clear interface systems.',
                ['Wireframe structures', 'Visual hierarchy', 'Components and spacing', 'Responsive interface planning'],
            ),
            (
                'Prototypes and Portfolio Work',
                'Package your work into strong portfolio-ready outcomes.',
                ['Interactive prototyping', 'Case study storytelling', 'Design presentation', 'Iteration and polish'],
            ),
        ],
    },
]
    ...
    def handle(self, *args, **options):
        ...
        for seed in COURSE_SEEDS:
            ...
            for index, (question, answer) in enumerate(seed['faqs']):
                CourseFAQ.objects.create(course=course, question=question, answer=answer, sort_order=index)
