...
class FreeResourceDetailSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        self._replace_children(resource, 'outcomes', FreeResourceOutcome, outcomes, FreeResourceOutcomeSerializer)
        self._replace_children(resource, 'modules', FreeResourceModule, modules, FreeResourceModuleSerializer)
        ...
        self._replace_children(resource, 'includes', FreeResourceInclude, includes, FreeResourceIncludeSerializer)
        return resource
    ...
    def update(self, instance, validated_data):
        ...
        if outcomes is not None:
            self._replace_children(instance, 'outcomes', FreeResourceOutcome, outcomes, FreeResourceOutcomeSerializer)
        if modules is not None:
            self._replace_children(instance, 'modules', FreeResourceModule, modules, FreeResourceModuleSerializer)
        ...
        if includes is not None:
            self._replace_children(instance, 'includes', FreeResourceInclude, includes, FreeResourceIncludeSerializer)
        return instance
