...
class OtpApiTests(APITestCase):
    ...
    @override_settings(DEBUG=True, EMAIL_HOST_USER='noreply@example.com', EMAIL_HOST_PASSWORD='secret', DEFAULT_FROM_EMAIL='noreply@example.com')
    ...
    def test_generate_otp_sends_whatsapp_when_twilio_is_configured(self, mocked_post, mocked_send_mail):
        mocked_send_mail.return_value = 1
